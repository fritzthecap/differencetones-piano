...
public final class Main
{
    ...
    private Action buildNotesPianoPlayer() {
        final String title = "NotesPianoPlayer";
        final Action action = new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                throw new RuntimeException("Implement me!");
    ...
    private Action buildDifferenceToneInversionsPiano() {
        final String title = "DifferenceToneInversionsPiano";
        final Action action = new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                throw new RuntimeException("Implement me!");
    ...
    private Action buildDifferenceToneForIntervalPiano() {
        final String title = "DifferenceToneForIntervalPiano";
        final Action action = new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                throw new RuntimeException("Implement me!");
    ...
    private Action buildJustIntonationCheckerConfiguration() {
        final String title = "JustIntonationCheckerConfiguration";
        final Action action = new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                throw new RuntimeException("Implement me!");
    ...
    private Action buildPianoConfiguration() {
        final String title = "PianoConfiguration";
        final Action action = new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                throw new RuntimeException("Implement me!");
    ...
    private Action buildTriadPlayingPiano() {
        final String title = "TriadPlayingPiano";
        final Action action = new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                throw new RuntimeException("Implement me!");
