...
public class DifferenceToneForIntervalPianoDemo
{ 
    public static void main(String[] args) {
        ...
        final JFrame frame = new JFrame("DifferenceToneForIntervalPiano ("+scale+", "+octaves+" Octaves)");
        ...
        final PianoWithSound piano = new DifferenceToneForIntervalPiano(config, new SineWaveSoundChannel(toneSystem.tones()));
